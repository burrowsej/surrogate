...
Automatically selects between a single-layer GP and a Deep GP based on the data.
...
- Predictions include mean, std, and 95% credible intervals
- Estimate cross-output correlations from posterior samples
